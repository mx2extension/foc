    ...
    <div className="max-w-7xl mx-auto py-32 px-6">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Link href="/dashboard/admin/news" className="premium-card p-8 hover:border-primary/30 transition">
          <i className="fas fa-newspaper text-2xl text-primary mb-4"></i>
        ...
        <Link href="/dashboard/admin/messages" className="premium-card p-8 hover:border-primary/30 transition">
          <i className="fas fa-inbox text-2xl text-accent mb-4"></i>
        ...
        <Link href="/dashboard/admin/newsletter" className="premium-card p-8 hover:border-primary/30 transition">
          <i className="fas fa-envelope-open-text text-2xl text-ink mb-4"></i>
        ...
        <Link href="/dashboard/admin/payments" className="premium-card p-8 hover:border-primary/30 transition">
          ...
          <p className="text-sm text-muted">Track all Paystack & Flutterwave transactions.</p>
        </Link>
        ...
        <Link href="/dashboard/admin/foc-products" className="premium-card p-8 hover:border-primary/30 transition">
          <i className="fas fa-shopping-bag text-2xl text-primary mb-4"></i>
          <h3 className="serif text-2xl mb-2">Our Products</h3>
          <p className="text-sm text-muted">Upload and manage shop inventory.</p>
        </Link>

        <Link href="/dashboard/admin/shop-orders" className="premium-card p-8 hover:border-primary/30 transition">
          <i className="fas fa-truck-fast text-2xl text-accent mb-4"></i>
          <h3 className="serif text-2xl mb-2">Shop Orders</h3>
          <p className="text-sm text-muted">View guest shop orders & update tracking.</p>
        </Link>

        <Link href="/dashboard/admin/shop-ads" className="premium-card p-8 hover:border-primary/30 transition">
          <i className="fas fa-rectangle-ad text-2xl text-ink mb-4"></i>
          <h3 className="serif text-2xl mb-2">Shop Adverts</h3>
          <p className="text-sm text-muted">Manage banner ads & monetization.</p>
        </Link>
      </div>
    </div>
  )
